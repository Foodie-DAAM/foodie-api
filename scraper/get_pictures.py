...
def save_picture(recipes_raw, url):
    ...
    path_save = path.join(config.path_img, '{}.jpg'.format(URL_to_filename(url)))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--filename', type=str, default='recipes_raw.json', help='Recipe JSON file')
